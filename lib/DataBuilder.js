...
// async.each was working flawlessly (and blazing fast !) locally but failed on server. async.eachSeries, seems to process operations sequentially. It's slower, but doesn't fail .
  async.eachSeries(lines, function(line, done) {
    log.debug('line', line)
    request
      .post({
